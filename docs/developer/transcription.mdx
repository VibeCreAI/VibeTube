---
title: "Transcription"
description: "How Whisper-based audio transcription works in VibeTube"
---

## Overview

VibeTube uses OpenAI's Whisper model for automatic speech recognition (ASR). This powers the transcription feature for creating reference text from audio recordings.
...
Whisper supports 99+ languages. Common ones in VibeTube:
...
transcription = await whisper.transcribe(audio_path, language="ko")
```
